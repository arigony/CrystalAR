...
assert.match(dom, /Versão v5\.3\.1/, `A versão 5.3.1 não apareceu no DOM renderizado.\n${stderr}`);
...
assert.match(dom, /assets\/minerals\/diamond\.jpg\?v=5\.3\.1/, `A fotografia de diamante não foi sincronizada ao roteiro inicial.\n${stderr}`);
assert.match(dom, /Diamante natural transparente, branco e octaédrico arredondado/i, `O texto alternativo da fotografia de diamante está ausente.\n${stderr}`);
...
console.log("Browser smoke PASS: CrystalAR 5.3.1 e roteiro diamante-grafite carregados no navegador real.");
