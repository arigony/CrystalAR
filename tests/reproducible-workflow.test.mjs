...
test("a interface apresenta CrystalAR 5.3.2 e o fluxo em duas etapas", () => {
...
test("a proveniência inclui versão, identificador, URI e SHA-256", () => {
  ...
  assert.match(workflow, /APP_VERSION = "v5\.3\.2"/);
...
test("a galeria-base mantém quinze estruturas e o módulo científico acrescenta oito rotas", () => {
  ...
  assert.match(watchdog, /science-v510\.js\?v=5\.3\.2/);
});
